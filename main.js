...
//CREATING THE WORLD 
const circleGeo = new t.IcosahedronGeometry(1.0, 8);
const circleGeo2 = new t.IcosahedronGeometry(0.2, 8); 
const color = new t.MeshStandardMaterial({
    map: tl.load("./assets/night.jpg"),
    //flatShading: true
    // transparent: false,
    blending: t.AdditiveBlending,
});
const moonMat = new t.MeshStandardMaterial({
    map: tl.load("./assets/moon.jpg")
});
const clouds = new t.MeshStandardMaterial({
    map: tl.load("./assets/clouds.jpg"),
    opacity: 0.5,
    //side: t.DoubleSide,
    depthWrite: false,
    transparent: true
...
//TODO:
/**
 * Timer - set timer, break, stop and the timer
 * Change music - new songs, next button, previous putton
 * HIDE TIMER OPTION
 */
